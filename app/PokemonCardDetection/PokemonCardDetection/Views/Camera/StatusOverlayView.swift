...
#Preview("Interrupted") {
    CameraView(cameraModel: PreviewCameraModel(status: .interrupted))
}

#Preview("Failed") {
    CameraView(cameraModel: PreviewCameraModel(status: .failed))
}

#Preview("Unauthorized") {
    CameraView(cameraModel: PreviewCameraModel(status: .unauthorized))
}
